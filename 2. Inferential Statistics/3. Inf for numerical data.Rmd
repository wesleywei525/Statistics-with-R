...
ggplot(nc, mapping = aes(x = habit, y = weight)) + geom_boxplot(fill = '#99CCFF', colour = '#6666ff')
```
...
inference(y = weeks, data = nc, type = "ci", statistic = "mean", conf_level = 0.99,method = "theoretical")
```
