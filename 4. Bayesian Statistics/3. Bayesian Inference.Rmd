...
```{r}
bayes_inference(y = weight, x = habit, data = nc, statistic = "mean", type = "ht", null = 0, alternative = "twosided", beta_prior= Beta(75,925))
```
...
```{r}
bayes_inference(y = premie, x = habit, data = nc, statistic = "proportion", type = "ht", null = 0, alternative = "twosided", success = 'premie')
```
