...
summary(m_lwage_iq)
m_lwage_iq$coefficients[2]-qt(0.975,933)*0.0008694
m_lwage_iq$coefficients[2]-qnorm(0.975)*0.0008694
confint(m_lwage_iq)
...
BIC_nobrthord = BIC(lm(lwage ~ . -wage - brthord, data = na.omit(wage)))
BIC_nosibs = BIC(lm(lwage ~ . -wage -sibs, data = na.omit(wage)))
BIC_nofeduc = BIC(lm(lwage ~ . -wage -feduc, data = na.omit(wage)))
BIC_nomeduc = BIC(lm(lwage ~ . -wage -meduc, data = na.omit(wage)))
c(BIC_nobrthord,BIC_nosibs,BIC_nofeduc,BIC_nomeduc)
...
wage_no_na = na.omit(wage_red)
bma_lwage_zs = bas.lm(lwage ~ . -wage, data = wage_no_na,
                   prior = "ZS-null", 
                   modelprior = beta.binomial(1, 1))
bma_lwage_zs
summary(bma_lwage_zs)
```
